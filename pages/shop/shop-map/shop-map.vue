...
<template>
	<view>
		<view class="page-body">
			...
			<image src="../../../static/img/category/category_list/place.png" mode=""></image>
		</view>
	</view>
</template>
		...
		data() {
			return {
				...
				covers: [{
				    ...
				    iconPath: '../../../static/img/category/category_list/place.png',	//显示的图标			
					title:'阿打算',//标注点名
					label:{//为标记点旁边增加标签
				            content:'文本1',//文本
				            color:'#F76350',//文本颜色
...
// 					  }
				    ...
				    latitude: 39.90,
				    longitude: 116.39,
				    iconPath: '../../../static/img/category/category_list/place.png',
					title:'阿迪达斯',
					x:39.90,
					y:116.399,
					label:{
